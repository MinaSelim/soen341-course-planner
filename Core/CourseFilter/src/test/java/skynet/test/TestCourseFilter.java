...
public class TestCourseFilter {
	...
	public void testSOEN() throws IOException 
	{
		...
		assertEquals(checkValue,
				CourseFilter.FilterListForProgram(testInputList, CourseFilter.getFilterForProgram("SOEN")).size());
	}
	...
	public void testCOMP() throws IOException
	{
		...
		assertEquals(checkValue,
				CourseFilter.FilterListForProgram(testInputList, CourseFilter.getFilterForProgram("COMP")).size());
	}
	...
	public void testSOENNull() throws IOException
	{
		...
		assertNotNull(CourseFilter.FilterListForProgram(null, null));
